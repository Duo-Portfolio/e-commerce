...
const SignUpForm = () => {
  return (
    ...
    >
      ...
      {/* Form Container */}
      <motion.div
        className="relative bg-black bg-opacity-90 border border-gray-900 p-12 rounded-3xl shadow-lg w-11/12 max-w-lg"
      ...
      >
        ...
        <h2 className="relative text-4xl font-bold text-center text-white mb-6 tracking-widest uppercase">
          Create Account
        </h2>
          ...
          {['Username', 'Email', 'Password', 'Confirm Password'].map((placeholder, index) => (
            <div className="relative flex items-center" key={index}>
              <input
                ...
                onFocus={(e) =>
                  e.target.type === 'password' ? e.target.setAttribute('autocomplete', 'new-password') : ''
                }
              />
