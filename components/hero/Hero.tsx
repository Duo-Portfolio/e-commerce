...
const Hero = () => {
  return (
    <section className="relative h-screen flex flex-col items-center justify-center text-center text-white px-4 overflow-hidden z-10"> {/* Ensure content is above the background video */}
      ...
      <motion.h1
        className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-purple-700 to-black drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] z-20"
      ...
      {/* Hero Subtitle */}
      <motion.p
        className="mt-4 text-base sm:text-lg md:text-xl lg:text-2xl max-w-lg mx-auto text-blue-300 drop-shadow-[0_0_8px_rgba(0,183,255,0.8)] z-20"
      ...
      {/* Buttons */}
      <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 z-20">
